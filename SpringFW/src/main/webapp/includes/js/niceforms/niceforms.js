...
//var imagesPath = "img/";
var imagesPath = "../includes/js/niceforms/img/";
...
function NFDo(what) { console.log("NFDo"+what);
	var niceforms = document.getElementsByTagName('form');console.log("niceforms"+niceforms.length);
	...
	for(var q = 0; q < niceforms.length; q++) {
		if(identifier.test(niceforms[q].className)) {
			if(what == "start") { console.log("Load Niceforms");
				//Load Niceforms
...
function niceform(nf) {
	...
	nf.start = function() {console.log("start called");
